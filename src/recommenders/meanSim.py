...
class MeanSim(object):
    ...
    def fit(self, df):
        ...
        # Recebe a matriz de iteracao usuario-item
        user_item_interaction = self.sparse_repr.get_user_items_matrix(df)

        # Calcular a média das embeddings dos itens consumidos por cada usuário de forma vetorizada
        ...
        # Normaliza as embeddings médias dos usuários
        ...
        # Separa o calculo de similaridade em batchs
    ...
    def recommend(self, df):
        ...
        # Remove usuarios que nao estao no teste
